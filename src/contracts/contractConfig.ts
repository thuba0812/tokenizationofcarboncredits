...
export const CARBON_TOKEN_ADDRESS: string = '0x2279B7A0a67DB372996a5FaB50D91eAA73d2eBe6';

/** Địa chỉ contract MockUSDT (ERC20) */
export const MOCK_USDT_ADDRESS: string = '0xa513E6E4b8f2a923D98304ec87F64353C4D5C853';

/** Địa chỉ contract CarbonMarketplace */
export const MARKETPLACE_ADDRESS: string = '0x8A791620dd6260079BF849Dc5567aDC3F2FdC318';
